var hmImg = document.getElementById("hm-alzheimer");
//var uhImg = document.getElementById("uh-azheimer");
//var questionImg = document.getElementById("question-alzheimer");
//var ohImg = document.getElementById("oh-alzheimer");

window.onscroll = function () {
    if (document.documentElement.scrollTop > 500) {
        hmImg.classList.add("hm-slide");
    }
